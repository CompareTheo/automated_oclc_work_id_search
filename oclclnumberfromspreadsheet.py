    ...
    try:
        ...
        for index, row in queries_df.iterrows():
            ...
            try:
                ...
                # Save the 'OCLC Number' to the new column
                queries_df.at[index, 'OCLC Number'] = oclc_number
...
explanation_text = "This script queries the OCLC metadata search API service using ISBNs from a user-selected spreadsheet.\n\n"\
                   ...
                   "The 'OCLC Number' is then extracted from the query results and saved in the user-selected spreadsheet under a column named Work ID."
label = tk.Label(root, text=explanation_text, wraplength=300, justify="left")
label.pack(pady=10)

# Add a button to run the script
run_button = tk.Button(root, text="Find OCLC Number", command=run_script)
...
# Run the GUI
>>>>>>> b8e973341fa2ea6e0b2b70d10a16223631d51f1a
root.mainloop()